/**************************************************************************************
* Math Tutor:	Alternate version using some functions				      *
* 										      *
...
void additionProblems(int&, char&, double&, int&, double&, double&, long double&);
void subtractionProblems(int&, char&, double&, int&, double&, double&, long double&);
void multiplicationProblems(int&, char&, double&, int&, double&, double&, long double&);
void divisionProblems(int&, char&, double&, int&, double&, double&, long double&);
...
int main()
{
	...
	do
	{
		...
		{
		case 1: 
			//Call the addition problems function
			additionProblems(numOfDigits, decimals, randomNumber, randomDecimal, num1, num2, answer);
			break;

		case 2: 
			//Call the subtraction problems function
			subtractionProblems(numOfDigits, decimals, randomNumber, randomDecimal, num1, num2, answer);
			break;

		case 3: 
			//Call the multiplication problems function
			multiplicationProblems(numOfDigits, decimals, randomNumber, randomDecimal, num1, num2, answer);
			break;

		case 4:
			//Call the division problems function
			divisionProblems(numOfDigits, decimals, randomNumber, randomDecimal, num1, num2, answer);
			break;
		}//End switch
...
//Function that creates addition problems/exercices
void additionProblems(int &numOfDigits, char &decimals, double &randomNumber, int &randomDecimal,
	double &num1, double &num2, long double &answer)
{
	cout << "\nADDITION PROBLEM!\n\n"
	...
	//If the user wants a one digit problem
	if (numOfDigits == 1)
	{
...
//Function that creates subtraction problems/exercices
void subtractionProblems(int &numOfDigits, char &decimals, double &randomNumber, int &randomDecimal,
	double &num1, double &num2, long double &answer)
{
	cout << "\nSUBTRACTION PROBLEM!\n\n"
		<< "Of how many digits you want your problem to be?\n"
...
//Function that creates multiplication problems/exercices
void multiplicationProblems(int &numOfDigits, char &decimals, double &randomNumber, int &randomDecimal,
	double &num1, double &num2, long double &answer)
{
...
//Function that creates divisipn problems/exercices
void divisionProblems(int &numOfDigits, char &decimals, double &randomNumber, int &randomDecimal,
	double &num1, double &num2, long double &answer)
{
	cout << "\nDIVISION PROBLEM!\n\n"
		<< "Of how many digits you want your problem to be?\n"
